...
source: https://www.aixq.cc/23152.html
author:
published: 2026-04-21
created: 2026-05-08
description: 大家好，我是苍何。 最近 AI 的热风从龙虾吹到了 Hermes Agent，也就是江湖外号「爱马仕」。 虽然现实中这玩意买不起，但这个还是能玩的起的。我同样跑通了不少工作流。 就包括之前龙虾的多智能…
tags:
  - clippings
---
大家好，我是苍何。
...
![万字保姆级教程：Hermes+Kimi K2.6 打造7x24h Agent军团](https://tu.aixq.cc/wp-content/uploads/2026/04/20260421165012826.jpg!ys)
...
```
# 先测试 Node 是否装好node -vnpm -v# 如果有版本号，手动装 Node 依赖cd ~/.hermes/hermes-agent/webnpm install
```
