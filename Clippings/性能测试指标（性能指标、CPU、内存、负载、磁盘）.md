---
title: "性能测试指标（性能指标、CPU、内存、负载、磁盘）"
source: "https://blog.csdn.net/huace3740/article/details/160371564"
author:
  - "[[huace3740]]"
published: 2026-04-21
created: 2026-04-23
description: "文章浏览阅读370次，点赞10次，收藏11次。这些资料，对于做【软件测试】的朋友来说应该是最全面最完整的备战仓库，这个仓库也陪伴我走过了最艰难的路程，希望也能帮助到你！凡事要趁早，特别是技术行业，一定要提升技术功底。_系统性能指标"
tags:
  - "clippings"
---

性能测试指标是衡量系统性能的评价标准，常用的系统性能测试指标包括：响应时间、并发用户/并发、点击率、吞吐量、TPS/QPS、PV/UV； Linux 服务器常用的性能指标包括：CPU使用率、内存占用率、磁盘IO、系统平均负载等。
...
![](https://i-blog.csdnimg.cn/blog_migrate/1ed6604aa87052b46d283ca9ad7eea84.png)
...
点击量是衡量 网站 流量的一个指标，也就是点击数clicks，是对网站点击数据的统计。
...
PV和UV是衡量 web 网站性能容量的两个重要度量指标，经常用在电子商务网站领域中用来衡量网站的活跃度。
...
![](https://i-blog.csdnimg.cn/blog_migrate/b76c5e74910807ddcbd2daf632e1aa3f.png)
...
hi (hard interrupt): 表示处理硬 中断 的CPU时间比例；
...
![](https://i-blog.csdnimg.cn/blog_migrate/cf30f51e68c15b67f48a8292e11f85a0.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/cc993637942ecd8ab6e1c62599b7da42.png)

命令2：#top

![](https://i-blog.csdnimg.cn/blog_migrate/0b988457194e85ea2ba99e0cd4d834f4.png)

命令3：#w

![](https://i-blog.csdnimg.cn/blog_migrate/7aaaac5e63c83bff49222e4f52b0734f.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/ecc2138feb58c4054e334c82caaecaaf.png)

通过ll /dev/mapper命令可以查看dm-x与磁盘逻辑卷的映射关系;

![](https://i-blog.csdnimg.cn/blog_migrate/4a94fc7ff8fffdff738e240bbed74a3f.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/06dcf641fc8234b0b0b5970512d1c740.png)

命令2: # top //包含CPU、内存使用等情况，常用命令

![](https://i-blog.csdnimg.cn/blog_migrate/43c6e139d92d748d532f7eee86d95136.png)

#### 2.5.2 内存

命令1： # free –h

![](https://i-blog.csdnimg.cn/blog_migrate/d0a24501c94aab66d419502d9621ec75.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/0c56856c6471757289629be4c106153b.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/e8f00a38d4bf95599115e848031eddbd.png)

命令2：# df –h //查看文件系统的磁盘空间使用情况

![](https://i-blog.csdnimg.cn/blog_migrate/d6978462689b363f88276e193f87eafa.png)

#### 2.5.5 整体

命令：# vmstat 3 2 //每3秒一次，共2次

![](https://i-blog.csdnimg.cn/blog_migrate/b8bdfcf679d234b016cb95d718c13488.png)
